# home_passport/application contracts

## Purpose

Interface-only repository, query, command, filter, sorting, and pagination contracts for `home_passport`.
